    ...
    public void channelUp() {
        ...
        if (on) {
            if (this.channel <= 119) {
                ...
                this.channel = 1; //if current channel is 120 and channelUp is called, channel goes to 1
            }
        }
    }
    ...
    public void channelDown() {
        ...
        if (on) {
            if (this.channel >= 2) {
                ...
                this.channel = 120; //if current channel is 1 and channelDown is called, channel goes to 120
            }
        }
    }
